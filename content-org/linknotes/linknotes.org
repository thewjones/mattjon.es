...
** TODO Notes 14.7.2023                             :Cycling:Politics:Gaming:
:PROPERTIES:
...
{{< imgproc name="planner"
    command="Resize"
    options="1200x webp"
    imageCaption="AI generated photo of a male town planning proudly overseeing the building of a road through the countryside" 
...
Why is future for anything good in the world at the mercy of sweaty men, still thinking it's the 1960s,  getting all excited at the prospect of taking their internal combustion engines over tarmac freshly laid over or under the countryside and, in the case, an ancient and globally important monument. 

This is excerable in every sense, as well as deeply irresponsible for obvious reasons. Meanwhile neighbouring Wales has simply stopped building new roads.   
